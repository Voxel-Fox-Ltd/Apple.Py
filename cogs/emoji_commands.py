...
class EmojiCommands(vbu.Cog):
    ...
    @commands.guild_only()
    async def deleteemoji(self, ctx: vbu.Context, emoji: discord.Emoji):
        """
    ...
    @commands.guild_only()
    async def addemoji(
            self, ctx: vbu.Context, emoji: typing.Optional[typing.Union[discord.PartialEmoji, int, ImageUrl]] = None,
